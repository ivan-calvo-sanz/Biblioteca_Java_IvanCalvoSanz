...
public class _0601_Class_File_Funciones {
    ...
    public static int[][] leerFichero(File f) {
        ...
        try {
            ...
            Logger.getLogger(_0601_Class_File_Funciones.class
    ...
    public static void guardarMatrizFichero(File f, int[][] matriz) {
        try {
            ...
            Logger.getLogger(_0601_Class_File_Funciones.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
